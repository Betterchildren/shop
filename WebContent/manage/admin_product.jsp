...
<body>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">商品管理</span></div>
        </div>
                        ...
                        <c:forEach var="p" items="${plist }">
                        	<tr>
                        		...
                        		<td>
                        			...
                        			<a  href="/Shop/manage/admin_del?id=${p.PRODUCT_ID}">删除</a>
                        		</td>
                        	</tr>
	                    </c:forEach>
